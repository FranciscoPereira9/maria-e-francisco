...
import llamaImage from "@/assets/field.jpg";
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            <p className="font-elegant text-lg md:text-xl text-foreground leading-relaxed">
              We have everything to start our lives together. We did not prepare
              a wedding registry.
            </p>
            <p className="font-elegant text-lg md:text-xl text-foreground leading-relaxed">
          ...
          >
            ...
            >
              <motion.div
                ...
                animate={
                  isFlipped ? { rotateY: 180 } : { rotateY: [0, 20, 0, 0] }
                }
                transition={
                  isFlipped
                ...
                >
                  <div className="text-center space-y-6">
                    ...
                    <p className="font-elegant text-muted-foreground leading-relaxed">
                      Your generosity means the world to us. Any contribution
                      will help make our dream trip unforgettable.
                    </p>
                    <div className="pt-4 space-y-3">
                      <p className="font-elegant text-sm text-muted-foreground uppercase tracking-widest">
                        IBAN
                      </p>
                      <p className="font-elegant text-foreground text-sm md:text-base tracking-wide font-medium break-words">
